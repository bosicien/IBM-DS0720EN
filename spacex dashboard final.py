...
app.layout = html.Div(
    children=[
        html.H1(
            'SpaceX Launch Records Dashboard - Gabriel Anssuini',
            style={
                'textAlign': 'center', 
                'color': '#503D36',
                'font-size': 40
        ...
        dcc.Dropdown(
            ...
            value='ALL',
            placeholder="Search Launch Location Site",
            searchable=True
        ),
        html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        success_failure_counts = specific_df.groupby('class').size().reset_index(name='counts')
        fig = px.pie(
...
# --- TASK 4: PLACE THE NEW CALLBACK HERE ---
@app.callback(
